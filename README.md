...
Muốn nhận tiền thẳng vào tài khoản ngân hàng thay vì đi qua cổng thì điền khối
`payment.sepay.*` trong `src/main/resources/app.properties` rồi đổi
...
Chi tiết luồng và các chốt chặn: xem `docs/STRUCTURE.md` §3.7.
